...
set "base_path=%CD%\dev\elementor_widgets"
...
call upload_zip.bat "%zip_file%" elementor_widgets

for /f %%i in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd_HHmmss"') do set "timestamp=%%i"

set "update_url=https://devlibrary2021.wpengine.com/fivebyfive/elementor_widgets/update.php?slug=%slug%^&version=%version%^&api_key=N8nFybEdxaeCKDxJTtkY3RSnuiSR3s4a1as&t=%timestamp%"
